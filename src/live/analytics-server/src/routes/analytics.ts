...
// Docstring
/**
 * Loopware Online Subsystem @ Analytics Endpoint || Simple endpoint that does all the heavy lifting of the analytics system 
 */
						...
						.then(() => {
							...
							_writeData(analyticalTallyBlob, stringifyData(currentAnalyticalTallyBlob))
								...
								.then(() => {
									...
									// Debug
									console.log(currentAnalyticalDataBlob)
									console.log(currentAnalyticalTallyBlob)
